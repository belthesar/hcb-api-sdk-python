...
class InvoicesService(BaseService):
    ...
    def list_an_organizations_invoices(
        ...
        ...
        :return: Return a list of invoices
        :rtype: List[Invoice]
        """
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/api/v3/organizations/{{organization_id}}/invoices",
        ...
        return [Invoice._unmap(item) for item in response]

    @cast_models
    def get_a_single_invoice(self, invoice_id: str, expand: str = None) -> Invoice:
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        :return: Return a single invoice
        :rtype: Invoice
        """
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/api/v3/invoices/{{invoice_id}}",
                self.get_default_headers(),
            )
        ...
        return Invoice._unmap(response)
