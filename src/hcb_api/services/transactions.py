...
class TransactionsService(BaseService):
    @cast_models
    def list_an_organizations_transactions(
        self,
        organization_id: str,
        expand: str = None,
        page: int = None,
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/api/v3/organizations/{{organization_id}}/transactions",
        ...
        return [Transaction._unmap(item) for item in response]

    @cast_models
    def get_a_single_transaction(
        self, transaction_id: str, expand: str = None
    ) -> Transaction:
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        :return: Return a single transaction
        :rtype: Transaction
        """
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/api/v3/transactions/{{transaction_id}}",
                self.get_default_headers(),
            )
        ...
        return Transaction._unmap(response)
